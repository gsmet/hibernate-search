...
public final class ScopedAnalyzerReference implements AnalyzerReference {
	...
	private ScopedAnalyzerReference(ScopedAnalyzer scopedAnalyzer) {
	...
	public static class Builder {
		...
		public Builder addAnalyzer(String scope, AnalyzerReference analyzerReference) {
			scopedAnalyzer.addScopedAnalyzerReference( scope, analyzerReference );
			return this;
		}

		public Builder setGlobalAnalyzer(AnalyzerReference globalAnalyzerReference) {
			scopedAnalyzer.setGlobalAnalyzerReference( globalAnalyzerReference );
			return this;
		}

		public ScopedAnalyzerReference build() {
			return new ScopedAnalyzerReference( scopedAnalyzer );
		}
	}
